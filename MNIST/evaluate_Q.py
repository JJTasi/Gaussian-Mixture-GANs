...
aux_M_tf_sample, aux_S_tf_sample = infodcgan_model.sample_latent_encoder(image_tf_sample, visualize_dim)
...
for i in range(100):
    ...
    Mean, log_Sigma = sess.run(
                        [aux_M_tf_sample, aux_S_tf_sample],
                        feed_dict={
                            Z_tf_sample:test_z,
    ...
    label_list.append(compontent_list)
np.save('test_Mean.npy',Mean_list)
np.save('log_Sigma.npy',log_Sigma_list)
